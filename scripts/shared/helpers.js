...
const { ETHEREUM_URL, ETHEREUM_DEPLOY_KEY } = require("../../env.json");

const providers = {
  ethereum: new ethers.providers.JsonRpcProvider(ETHEREUM_URL),
};

const signers = {
  ethereum: new ethers.Wallet(ETHEREUM_DEPLOY_KEY).connect(providers.ethereum),
};
