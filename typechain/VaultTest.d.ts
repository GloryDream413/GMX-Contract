...
interface VaultTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "increaseGlobalShortSize(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "increaseGlobalShortSize",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export type UpdateFundingRateEvent = TypedEvent<
  [string, BigNumber] & { token: string; fundingRate: BigNumber }
>;
...
export class VaultTest extends BaseContract {
