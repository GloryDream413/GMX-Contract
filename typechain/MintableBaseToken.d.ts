...
interface MintableBaseTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class MintableBaseToken extends BaseContract {
  ...
  interface: MintableBaseTokenInterface;
